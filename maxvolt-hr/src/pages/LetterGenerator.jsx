...
const LETTER_TYPES = [
  ...
  { key: 'internship_offer',      label: 'Internship Offer Letter',      fields: [{ k: 'start_date', label: 'Training Start Date', type: 'date' }, { k: 'end_date', label: 'Training End Date', type: 'date' }, { k: 'tenure_months', label: 'Training Tenure (months)', type: 'number' }, { k: 'stipend', label: 'Monthly Stipend (₹)', type: 'number' }, { k: 'benefit', label: 'Benefit (optional)' }] },
  { key: 'internship_experience', label: 'Internship Experience Certificate', fields: [{ k: 'start_date', label: 'Internship Start Date', type: 'date' }, { k: 'end_date', label: 'Internship End Date', type: 'date' }, { k: 'work_summary', label: 'Work Summary (optional)', type: 'textarea' }] },
